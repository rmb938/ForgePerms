 ...
 * @author Ryan
 */
public class ToggleDownFall extends CommandToggleDownfall{
    ...
    public boolean canCommandSenderUseCommand(ICommandSender par1ICommandSender) {
        if (ForgePermsAPI.playerHasPermission(par1ICommandSender.getCommandSenderName(), "minecraft.toggledownfall")) {
            return true;
        }
        return false;
    }
